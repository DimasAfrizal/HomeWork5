    ...
    return (
        <div className="playlist-form">
            ...
            <form className="addPlaylistForm" onSubmit={handleAddPlaylistOnSubmit}>
                ...
                <TextField label="Your playlist title" variant="filled" size="small" className="title" id="title" type="text" value={addPlaylistData.title} onChange={handleAddPlaylistOnChange} name="title" minLength="10"/>
                <br />
